...
Public Class Libreoffice
    ...
    Dim x, p As Integer
    Private Sub Libreoffice_Load(sender As Object, e As EventArgs) Handles MyBase.Load



        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_9b0300fe79fc493aaa6d84d44f224edf.zip"), Texbbb.TextBox3.Text)
        Timer1.Start()
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs)
        ...
        '        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_b9a39c1004de491984f5c7d1fc5d11df.zip"), TextBox1.Text)
    End Sub
