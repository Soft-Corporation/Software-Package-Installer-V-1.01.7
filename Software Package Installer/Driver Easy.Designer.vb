...
Partial Class Driver_Easy
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label3.Text = "Download di Driver Easy"
        '
        'Timer1
        '
        '
