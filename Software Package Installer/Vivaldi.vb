...
Public Class Vivaldi
    ...
    Private Sub Vivaldi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_c8e14a3513234950b6335911b8938f45.zip"), Texbbb.TextBox33.Text)
