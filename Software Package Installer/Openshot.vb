...
Public Class Openshot
    ...
    Private Sub Openshot_Load(sender As Object, e As EventArgs) Handles MyBase.Load



        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_59a48c21b87d4aa08c6a3dc642f73e30.zip"), Texbbb.TextBox38.Text)
