...
Public Class Avast
    ...
    Private Sub Avast_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_d2e03091d0164eab8632f79226697ddb.zip"), Texbbb.TextBox67.Text)
