...
Public Class Rufus
    ...
    Private Sub Rufus_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_88d81c87a5d74328b75d7d3ac54f8541.zip"), Texbbb.TextBox36.Text)
