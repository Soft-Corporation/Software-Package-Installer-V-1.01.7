...
Public Class Obs
    ...
    Private Sub Obs_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_76a7783519f449dc877c4b7ba2bdbce0.zip"), Texbbb.TextBox19.Text)
        Timer1.Start()
