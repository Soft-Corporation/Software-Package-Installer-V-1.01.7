...
Public Class Itunes
    ...
    End Sub
    Private Sub Itunes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_d3ff229139884c8eb882ee0656ed4210.zip"), Texbbb.TextBox65.Text)
