...
Public Class Mega
    ...
    End Sub
    Private Sub Mega_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_4b434414e7d04b55ae230220e9a80308.zip"), Texbbb.TextBox73.Text)
