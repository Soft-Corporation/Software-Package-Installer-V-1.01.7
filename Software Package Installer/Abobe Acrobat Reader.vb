...
Public Class Abobe_Acrobat_Reader
    ...
    Private Sub Abobe_Acrobat_Reader_Load(sender As Object, e As EventArgs) Handles MyBase.Load



        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_1efcfd1c3b2d4ae1a5870bc4709bf1be.zip"), Texbbb.TextBox24.Text)
        Timer1.Start()
