...
Public Class Vim
    ...
    Private Sub Vim_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_bd8321e965dd4e8681e6b0985c410563.zip"), Texbbb.TextBox70.Text)
