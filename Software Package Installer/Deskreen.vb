...
Public Class Deskreen
    ...
    Private Sub Deskreen_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_14f4bfc284ef4c7ba4b361093df8d081.zip"), Texbbb.TextBox76.Text)
