...
Public Class Greenshot
    ...
    Private Sub Greenshot_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_51ed885f14784eb79e4c27ccc442da12.zip"), Texbbb.TextBox78.Text)
