...
Public Class Dev_C__
    ...
    End Sub
    Private Sub Dev_C___Load(sender As Object, e As EventArgs) Handles MyBase.Load



        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_04bd611ee8d643de8ea88be9e8fabe34.zip"), Texbbb.TextBox45.Text)
        Timer1.Start()
