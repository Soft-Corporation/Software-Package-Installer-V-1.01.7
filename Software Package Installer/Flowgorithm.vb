...
Public Class Flowgorithm
    ...
    Private Sub Flowgorithm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_9072eb5e9fb74c7bb84e1fd0560349a2.zip"), Texbbb.TextBox20.Text)
