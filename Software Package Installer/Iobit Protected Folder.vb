...
Public Class Iobit_Protected_Folder
    ...
    End Sub
    Private Sub Iobit_Protected_Folder_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_2395db51d073429489ad7bdc5ca7cb95.zip"), Texbbb.TextBox60.Text)
