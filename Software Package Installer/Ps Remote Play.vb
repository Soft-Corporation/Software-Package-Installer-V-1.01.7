...
Public Class Ps_Remote_Play
    ...
    End Sub
    Private Sub Ps_Remote_Play_Load(sender As Object, e As EventArgs) Handles MyBase.Load



        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_c0613bfc446942d48acf932c9b8fe2c1.zip"), Texbbb.TextBox64.Text)
