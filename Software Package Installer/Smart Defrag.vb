...
Public Class Smart_Defrag
    ...
    End Sub
    Private Sub Smart_Defrag_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_a30f76cf725e494abbde2659a456758c.zip"), Texbbb.TextBox59.Text)
