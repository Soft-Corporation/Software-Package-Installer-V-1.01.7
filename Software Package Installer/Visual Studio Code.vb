...
Public Class Visual
    ...
    Private Sub Vsc_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_d757cbbe07004096b0c8cbb49d7aa059.zip"), Texbbb.TextBox1.Text)
        Timer1.start
    End Sub
