...
Public Class TunnelBear
    ...
    Private Sub TunnelBear_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_b75b1897488d49078f20e3aad0b316a1.zip"), Texbbb.TextBox71.Text)
