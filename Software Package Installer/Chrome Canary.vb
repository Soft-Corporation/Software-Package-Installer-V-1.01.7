...
Public Class Chrome_Canary
    ...
    Private Sub Chrome_Canary_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_172738c14b194752b5c0df0d859f36fd.zip"), Texbbb.TextBox53.Text)
        Timer1.Start()
