...
Public Class File_Converter
    ...
    Private Sub File_Converter_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_eb946db663be4a88859b8cf25d77af5b.zip"), Texbbb.TextBox79.Text)
