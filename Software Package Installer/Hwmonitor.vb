...
Public Class Hwmonitor
    ...
    Private Sub Hwmonitor_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_c93b0c5cee29462f969945799e25ae43.zip"), Texbbb.TextBox9.Text)
        Timer1.Start()
    ...
    Private Sub Panel8_MouseUp(sender As Object, e As MouseEventArgs) Handles Panel8.MouseUp
