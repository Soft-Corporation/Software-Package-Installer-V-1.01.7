...
Public Class Virtualbox
    ...
    Private Sub Virtualbox_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_f2cd967b69ae46e6a82baeafdadbfc23.zip"), Texbbb.TextBox14.Text)
        Timer1.Start()
