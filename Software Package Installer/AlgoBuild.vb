...
Public Class AlgoBuild
    ...
    End Sub
    Private Sub AlgoBuild_Load(sender As Object, e As EventArgs) Handles MyBase.Load



        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_54595c7ddf9447a491601c5450e3d181.zip"), Texbbb.TextBox46.Text)
