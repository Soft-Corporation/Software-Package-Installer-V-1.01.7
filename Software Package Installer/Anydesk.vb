...
Public Class Anydesk
    ...
    Private Sub Anydesk_Load(sender As Object, e As EventArgs) Handles MyBase.Load


        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_2692292d43664eb0a6c80adf736386bd.zip"), Texbbb.TextBox30.Text)
        Timer1.Start()
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs)
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_9a3f71b382ab44588bb9725def0747b4.zip"), TextBox1.Text)
    End Sub
