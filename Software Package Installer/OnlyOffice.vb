...
Public Class OnlyOffice
    ...
    Private Sub OnlyOffice_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_a310329c1461472c8d3803896eeeacb9.zip"), Texbbb.TextBox35.Text)
