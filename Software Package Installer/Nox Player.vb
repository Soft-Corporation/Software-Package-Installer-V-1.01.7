...
Public Class Nox_Player
    ...
    Private Sub Nox_Player_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_72ae735eee164c899e53cdb58ce1e116.zip"), Texbbb.TextBox43.Text)
