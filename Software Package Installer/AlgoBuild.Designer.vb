...
Partial Class AlgoBuild
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label3.Text = "Download di Algobuild"
        '
        'Timer5
        '
        '
