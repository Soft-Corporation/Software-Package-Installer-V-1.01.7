...
Public Class BAlena_Etcher
    ...
    Private Sub BAlena_Etcher_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_be1f4c9d33c3462aba5ca5d2d598ef54.zip"), Texbbb.TextBox75.Text)
