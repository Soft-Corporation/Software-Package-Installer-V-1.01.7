...
Public Class Edge_Beta
    ...
    Private Sub Edge_Beta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_649b2e2a205a4781891481aedc4df52d.zip"), Texbbb.TextBox80.Text)
