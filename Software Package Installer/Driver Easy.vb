...
Public Class Driver_Easy
    ...
    Private Sub Driver_Easy_Load(sender As Object, e As EventArgs) Handles MyBase.Load


        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_db957b5b66e44d79945394ce002c240f.zip"), Texbbb.TextBox39.Text)
        Timer1.Start()
    ...
    Private Sub Timer2_Tick(sender As Object, e As EventArgs) Handles Timer12.Tick
