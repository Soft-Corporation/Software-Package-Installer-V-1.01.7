...
Public Class Nvidia_Geforce_Experience
    ...
    Private Sub Nvidia_Geforce_Experience_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_f0b199e96f524f2aade6d2ec6057928e.zip"), Texbbb.TextBox55.Text)
