...
Public Class Audacity
    ...
    Private Sub Audacity_Load(sender As Object, e As EventArgs) Handles MyBase.Load



        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_a66d272be6d44fa592f976b91a04630d.zip"), Texbbb.TextBox25.Text)
