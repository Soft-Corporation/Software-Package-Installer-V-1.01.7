...
Public Class Steam
    ...
    Private Sub Steam_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_f9c4b8a57a3a46f7921a8ba1f2aab08f.zip"), Texbbb.TextBox13.Text)
        Timer1.Start()
