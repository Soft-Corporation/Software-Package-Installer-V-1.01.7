...
Public Class Sky_Go
    ...
    Private Sub Sky_Go_Load(sender As Object, e As EventArgs) Handles MyBase.Load



        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_e2d02f540a3d40e2b37f047728a8e83b.zip"), Texbbb.TextBox16.Text)
