...
Public Class Logitech_G_Hub
    ...
    Private Sub Logitech_G_Hub_Load(sender As Object, e As EventArgs) Handles MyBase.Load



        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_13c1817335b7443abb7842162afe7c60.zip"), Texbbb.TextBox29.Text)
